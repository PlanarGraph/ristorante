defmodule RistoranteWeb.UserControllerTest do
  ...
  @create_attrs %{address: "some address", email: "some email", first_name: "some first_name", last_name: "some last_name", password: "some password", password_hash: "some password_hash", username: "some username"}
